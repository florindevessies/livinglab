/*
Script for the animated water visualisation for DGTL festival
...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        waveRiseTime: 7000, // The amount of time in milliseconds for the wave to rise from 0 to it's final height.
