...
flows2[1,"color_from"] <- "#186134"
flows2[2,"color_from"] <- "#186134"
flows2[3,"color_from"] <- "#186134"
flows2[4,"color_from"] <- "#737574"
flows2[5,"color_from"] <- "#186134"
flows2[6,"color_from"] <- "#186134"
flows2[7,"color_from"] <- "#186134"
flows2[8,"color_from"] <- "#186134"
flows2[9,"color_from"] <- "#186134"
flows2[10,"color_from"] <- "#737574"
flows2[11,"color_from"] <- "#737574"
flows2[12,"color_from"] <- "#186134"
flows2[13,"color_from"] <- "#186134"
flows2[14,"color_from"] <- "#186134"
flows2[15,"color_from"] <- "#737574"
flows2[16,"color_from"] <- "#186134"
flows2[17,"color_from"] <- "#186134"
flows2[18,"color_from"] <- "#186134"
flows2[19,"color_from"] <- "#186134"

flows2$color_to <- "color"
flows2[1,"color_to"] <- "#0BCC50"
flows2[2,"color_to"] <- "#0BCC50"
flows2[3,"color_to"] <- "#0BCC50"
flows2[4,"color_to"] <- "#737574"
flows2[5,"color_to"] <- "#0BCC50"
flows2[6,"color_to"] <- "#0BCC50"
flows2[7,"color_to"] <- "#0BCC50"
flows2[8,"color_to"] <- "#0BCC50"
flows2[9,"color_to"] <- "##0BCC50"
flows2[10,"color_to"] <- "#737574"
flows2[11,"color_to"] <- "#737574"
flows2[12,"color_to"] <- "#0BCC50"
flows2[13,"color_to"] <- "#0BCC50"
flows2[14,"color_to"] <- "#0BCC50"
flows2[15,"color_to"] <- "#737574"
flows2[16,"color_to"] <- "#0BCC50"
flows2[17,"color_to"] <- "#0BCC50"
flows2[18,"color_to"] <- "#0BCC50"
flows2[19,"color_to"] <- "#0BCC50"
...
dgtl$hover <- "Generatior <br> kWh <br> CO2 <br> NOx"
dgtl[1,"hover"]<-"Modular <br> kWh <br> CO2 <br> Nox "
dgtl[2,"hover"]<- "Generator <br> kWh <br> CO2 <br> NOx"
dgtl[3,"hover"]<- "Skyline <br> kWh <br> Co2 <br> NOx"
dgtl[4,"hover"]<- "Kornuit <br> kWh <br> CO2 <br> NOx"
dgtl[5,"hover"]<- "Art <br> kWh <br> CO2 <br> NOx"
dgtl[6,"hover"]<- "AMP <br> kWh <br> CO2 <br> NOx"
dgtl[7,"hover"]<- "Live <br> kWh <br> CO2 <br> NOx"
dgtl[8,"hover"]<- "foodcourt <br> kWh <br> CO2 <br> NOx"
