...
/*    var metadata = {"CO2" : {'title' : "co2 title", 'asnaam': 'asnaam'},*/
var metadata = {
    "CO2": {'title': "Festival systems responsible for DGTL's CO2 emissions", 'yTitle': 'tonnes '},
    "NOx" : {'title': "Festival systems responsible for DGTL's NOx emissions", 'yTitle': 'tonnes'},
    "Fresh water use" : {'title': "Festival systems responsible for DGTL's fresh water usage", 'yTitle': 'liters'},
    "Chemical pollution" : {'title': "Festival systems responsible for DGTL's chemical pollution", 'yTitle': 'tonnes'},
...
function setUpColors() {
    return d3.scaleOrdinal()
        .range(["#100e26", "#0f0f38", "#1e194d", "#2c2d70", "#2f3189", "#a3a1a2"]);
}
